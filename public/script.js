...
gsap.fromTo(
  ".form_anim",
  { scale: 0, transformOrigin: "100% 0", opacity: 1 }, // Starting state
  {
    scale: 1,
...
document.addEventListener("DOMContentLoaded", function () {
  // First progress bar
  let gradientStart1 = document.querySelector(
    "#GradientColor1 stop:first-child"
  );
  ...
  // Second progress bar
  let gradientStart2 = document.querySelector(
    "#GradientColor2 stop:first-child"
  );
  ...
  // Third progress bar
  let gradientStart3 = document.querySelector(
    "#GradientColor3 stop:first-child"
  );
  ...
  let gradientStart4 = document.querySelector(
    "#GradientColor4 stop:first-child"
  );
...
// // Update GSAP ScrollTrigger with Lenis
